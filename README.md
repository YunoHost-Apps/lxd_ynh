...
**Shipped version:** 5.6~ynh1 *(:warning: This is the `testing` branch. The [`master` branch](https://github.com/YunoHost-Apps/lxd_ynh/tree/master) used in the catalog is currently on version 5.5\~ynh1.)*
